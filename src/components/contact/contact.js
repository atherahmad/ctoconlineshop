...
const Contact = (props) => {
  ...
  const submitHandler = async (e) => {
    e.preventDefault();
    if (
      !Object.keys(message).every((key) => message[key]) ||
      !regexEmail.test(message.email)
    )
      setFormError(true);
    else {
      const config = {
      ...
      axios
        .post(
          `${process.env.REACT_APP_DB_HOST}/api/contact/querry`,
          message,
          config
        )
        .then((res) => {
    ...
    <div className="contact">
      <div className="container">
            ...
            <div className="col-md-12 mb-md-0 mb-5">
              ...
              >
                ...
                <div className="text-center text-md-left mt-3">
                  <button className="myBlueButton-lg btn-block" type="submit">
                    Send
                  </button>
                  {formError ? (
                    <p className="sText">
                      *Please fill out all fields or check your email address
                    </p>
                  ) : null}
                </div>
              </form>
        ...
        <section className="mb-4" hidden={!hideForm}>
          ...
          <p className="text-center w-responsive mx-auto mb-5">
            We have recieved your querry and our support Team will repy on your
            given email address in next 48 Hours.
          </p>
          <button
            className="myBlueButton-lg btn-block"

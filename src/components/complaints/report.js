...
function ReportProduct(props) {
  ...
  const submitHandler = async () => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_DB_HOST}/api/contact/report`,
        productReport,
        config
      )
      .then((res) => {
  ...
  return (
    <div className="rpd">
      <div className="rpd-content">
        <div className="rpd-head"></div>
        <div className="rpd-head-title">Report Product</div>
        ...
        <div className="rpd-tilte">
          ...
          {reportStauts ? (
            <h3>
              We have successfully recieved your complaint regarding this
              product and will take action accordingly.
            </h3>
          ) : (
            <TextField

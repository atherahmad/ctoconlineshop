    ...
    <div>
      ...
      <div className="fixed-bottom">
        {profile.admin ? (
          <div>
            <button
              className="myIcons myRedButton-lg fa fa-ban"
              onClick={() => blockHandler(productId)}
            />
          </div>
        ) : creatorId ? (
          status !== "sold" ? (
            creatorId === profile.userId ? (
              status === "inactive" ? (
                <div>
                  <button
                    className="myOrabgeButton-lg ml-1"
                    onClick={() => activateHandler(productId)}
                  >
                    {" "}
                    Activate
                  </button>
                ...
                <div>
                  ...
                  <button
                    className="myOrabgeButton-lg ml-1"
                    onClick={() => deactivateHandler(productId)}
                  >
                    {" "}
                    In-Active
                  </button>
                  <button
                    className="myGreenButton-lg ml-1"
                    onClick={() => soldHandler(productId)}
                  >
                    {" "}
                    Sold{" "}
                  </button>
              ...
              <div>
                <div className="myIcon w-50 mx-auto">
                  <button
                    ...
                    onClick={() => favoriteHandler(productId)}
                  >
                    {" "}
                  </button>
                  <button
                    className="myIcons myRedButton-lg fa fa-ban"
                    onClick={() => reportHandler(productId)}
                  >
                    {" "}
                  </button>
                  <button
                    className="myOrabgeButton-lg fa fa-envelope "
